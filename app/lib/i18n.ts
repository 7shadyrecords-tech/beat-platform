...
export const translations = {
  fr: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "La marketplace la plus professionnelle que j'aie jamais utilisée. Aperçus instantanés, licences impeccables.",
          name: "Marcus V.",
          role: "Artiste Platine",
          avatar: "MV",
        },
        {
          quote: "12 000 € de beats vendus mon premier mois. Le tableau de bord analytique change tout.",
          name: "Lena K.",
          role: "Productrice",
          avatar: "LK",
        },
        {
          quote: "Qualité cinématique. Chaque beat semble mixé pour une major.",
          name: "Jay R.",
          role: "Directeur A&R",
          avatar: "JR",
        },
  ...
  en: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "The most polished beat marketplace I've ever used. Instant previews, flawless licensing.",
          name: "Marcus V.",
          role: "Platinum Artist",
          avatar: "MV",
        },
        {
          quote: "Sold $12K in beats my first month. The analytics dashboard is a game changer.",
          name: "Lena K.",
          role: "Producer",
          avatar: "LK",
        },
        {
          quote: "Cinematic quality. Every beat feels like it was mixed for a major label release.",
          name: "Jay R.",
          role: "A&R Director",
          avatar: "JR",
        },
  ...
  de: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "Die professionellste Beat-Marketplace, die ich je genutzt habe. Sofortige Vorschauen, tadellose Lizenzierung.",
          name: "Marcus V.",
          role: "Platin-Künstler",
          avatar: "MV",
        },
        {
          quote: "12.000 € Beats in meinem ersten Monat verkauft. Das Analytics-Dashboard ist ein Game Changer.",
          name: "Lena K.",
          role: "Produzentin",
          avatar: "LK",
        },
        {
          quote: "Kinematische Qualität. Jeder Beat klingt, als wäre er für ein Major-Label gemischt worden.",
          name: "Jay R.",
          role: "A&R Direktor",
          avatar: "JR",
        },
  ...
  es: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "La marketplace de beats más profesional que he usado. Vistas previas instantáneas, licencias impecables.",
          name: "Marcus V.",
          role: "Artista Platino",
          avatar: "MV",
        },
        {
          quote: "Vendí 12.000 € en beats mi primer mes. El panel de analítica es revolucionario.",
          name: "Lena K.",
          role: "Productora",
          avatar: "LK",
        },
        {
          quote: "Calidad cinematográfica. Cada beat parece mezclado para un sello discográfico mayor.",
          name: "Jay R.",
          role: "Director A&R",
          avatar: "JR",
        },
